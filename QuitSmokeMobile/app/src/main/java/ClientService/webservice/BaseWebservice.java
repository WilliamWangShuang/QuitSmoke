...
public class BaseWebservice {
    ...
    public static JSONArray postWebServiceForGetRestrieveJSONArray(String serviceUrl, JSONObject jsonParam) throws IOException {
        // response result
    ...
    public static String postWSForGetRestrievePlainText(String serviceUrl, JSONObject jsonParam) throws IOException {
        // response result
        String result = null;
        Log.d("QuitSmokeDebug", "url:" + serviceUrl + "\njsonParam:" + jsonParam);
        // declare a url connection
        HttpURLConnection urlConnection=null;
