...
public class QuitSmokeClientConstant {
    ...
    public static String GET_CLOSE_PLAN_SUPPORTER_VIEW = "api/Values/getQuitterClosePlan";
    ...
    public static String UPDATE_MILESTONE = "api/Values/updateMilestone";
    ...
    public static String WS_JSON_USER_KEY_PRICE_PER_PACK = "price_per_pack";
    ...
    public static String WS_INTERACT_REWARD = "reward";
